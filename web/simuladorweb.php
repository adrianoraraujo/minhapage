...
<html lang="en-US">
<head>
<title>Simulador de Webpage On-line</title>
...
<header class="w3-container w3-center w3-padding-32"> 
  <h1><b>SIMULADOR DE WEB ON-LINE</b></h1>
...
<div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="https://adrianoraraujo.herokuapp.com" class="w3-bar-item w3-button w3-teal"><i class="fa fa-home w3-margin-right"></i>Home</a>
<div><a href="javascript:void(0);" onclick="restack(currentStack)" title="Girar a tela" class="w3-bar-item w3-button" ><i style="font-size:20px" class="fa">&#xf01e;</i></a></div>
 <div> <a class="w3-bar-item w3-button w3-teal" title="Testar" onclick="submitTryit(1);snhb.startAuction(['try_it_leaderboard']);"><i style="font-size:20px" class="fa">&#xf144;</i></a>
 </div> 
...
<div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="javascript:void(0);" onclick="openMenu()" id="menuButton" title="Open Menu"class="w3-dropdown-click w3-button w3-bar-item topnav-icons fa fa-menu" style="font-size:20px;color:#999999;margin-top:0px"></a>
  <button href="javascript:void(0);" onclick="restack(currentStack)" title="Girar a tela" class="w3-bar-item w3-button" style="font-size:20px;color:#999999;margin-top:0px"><i style="font-size:20px" class="fa">&#xf01e;</i></button>
  <button class="w3-bar-item w3-button w3-teal" title="Testar" onclick="submitTryit(1);snhb.startAuction(['try_it_leaderboard']);"><i style="font-size:20px" class="fa">&#xf144;</i></button>
  <span class="w3-right w3-hide-medium w3-hide-small" style="padding:8px 8px 8px 8px;display:block"></span>
  <span class="3-padding-large w3-hover-red w3-hide-small w3-right" style="padding:8px 0;display:block;right;"><span id="framesize"></span></span>
</div>
</div>
</div>-->
<div id="shield"></div>
...
function showFrameSize() {
  ...
  document.getElementById("framesize").innerHTML = "Tamanho da Tela: <span>" + width + " x " + height + "</span>";
}
var dragging = false;
var stack;
function fixDragBtn() {
